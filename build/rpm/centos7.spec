...
install -m 644 %{gopath}/src/github.com/Donders-Institute/%{name}/cluster %{buildroot}/%{_sysconfdir}/bash_completion.d/cluster

%files
%{_bindir}/cluster
%{_sysconfdir}/bash_completion.d/cluster
